 ...
 * @author MOHIT
 */
public class bookmodification extends javax.swing.JInternalFrame {
Connection c=null;
Statement s=null;
ResultSet rs=null;
    /**
     * Creates new form bookmodification
     */
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setMinimumSize(new java.awt.Dimension(548, 409));
        setPreferredSize(new java.awt.Dimension(548, 409));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 540, 380));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String qry="update BOOKS set TITLE='"+t2.getText()+"',AUTHOR='"+t3.getText()+"',PAGE='"+t4.getText()+"',EDITION='"+t5.getText()+"',PRICE='"+t6.getText()+"',DATE='"+t7.getText()+"' where NO='"+t1.getText()+"'";
        try{
            s=c.createStatement();
            s.executeUpdate(qry);
...
try {
    s=c.createStatement();
    rs=s.executeQuery("select * from books where no="+t1.getText()+"");
rs.next();
